...
class AppTranslations {
  ...
  static final Map<String, Map<String, String>> _translations = {
    ...
    'de': {
      ...
      'rating_required': 'Bitte Rating eingeben',
      'rating_range_error': 'Rating muss zwischen 0 und 10 liegen',
      'continue': 'Weiter',
      ...
      // Manga Support (v1.5.0)
      'add_media_title': 'Was möchtest du hinzufügen?',
      'add_book_option': 'Buch',
      'add_book_subtitle': 'Mit ISBN-Suche',
      'add_manga_option': 'Manga-Serie',
      'add_manga_subtitle': 'Mit MyAnimeList-Suche',
      'add_manga_screen_title': 'Manga-Serie hinzufügen',
      'mal_search': 'MyAnimeList Suche',
      'mal_search_hint': 'Suche nach einem Manga, um Titel, Autor und Cover automatisch zu laden.',
      'manga_name': 'Manga-Name',
      'manga_name_example': 'z.B. "One Piece"',
      'search': 'Suchen',
      'search_results': 'Suchergebnisse',
      'details': 'Details',
      'volumes': 'Bände',
      'manga_selected': 'ausgewählt',
      'search_error': 'Fehler bei der Suche. Bitte erneut versuchen.',
      'continue_to_rating': 'Weiter zum Rating',
      'manga_added': 'Manga hinzugefügt!',
      'no_results': 'Keine Ergebnisse',
      'network_error': 'Netzwerkfehler',
      'loading': 'Lädt...',
      'title_required_error': 'Bitte Titel eingeben',
      'author_example': 'z.B. "Eiichiro Oda"',
      'year_example': 'z.B. 2024',
      'notes_hint': 'Zusätzliche Informationen',
      'cover_preview': 'Cover-Vorschau:',
      'cover_load_error': 'Fehler beim Laden',
      'skip_initial_rating': 'Anfangs-Rating überspringen',
      'skip_initial_rating_hint': 'Zufällige Position in Tier-List',

      // Navigation (v1.5.0)
      'menu': 'Menü',
      'more': 'Mehr',
      'import_export': 'Import & Export',
      'theme_selection': 'Farbschema',
    ...
    'en': {
      ...
      'rating_required': 'Please enter a rating',
      ...
      // Manga Support (v1.5.0)
      'add_media_title': 'What would you like to add?',
      'add_book_option': 'Book',
      'add_book_subtitle': 'With ISBN search',
      'add_manga_option': 'Manga Series',
      'add_manga_subtitle': 'With MyAnimeList search',
      'add_manga_screen_title': 'Add Manga Series',
      'mal_search': 'MyAnimeList Search',
      'mal_search_hint': 'Search for a manga to automatically load title, author and cover.',
      'manga_name': 'Manga Name',
      'manga_name_example': 'e.g. "One Piece"',
      'search': 'Search',
      ...
      'continue_to_rating': 'Continue to Rating',
      'manga_added': 'Manga added!',
      'no_results': 'No results',
      'network_error': 'Network error',
      'loading': 'Loading...',
      'title_required_error': 'Please enter a title',
      'author_example': 'e.g. "Eiichiro Oda"',
      'year_example': 'e.g. 2024',
      'notes_hint': 'Additional information',
      'cover_preview': 'Cover Preview:',
      'cover_load_error': 'Error loading',
      'skip_initial_rating': 'Skip initial rating',
      'skip_initial_rating_hint': 'Random position in tier list',

      // Navigation (v1.5.0)
      'menu': 'Menu',
      'more': 'More',
      'import_export': 'Import & Export',
      'theme_selection': 'Color Scheme',
